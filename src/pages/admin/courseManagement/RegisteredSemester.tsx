...
import { Tag ,Dropdown, Button, Table, TableColumnsType} from "antd";
...
const items = [
  ...
  export const RegisteredSemesters = () =>{
    ...
    const [updatedSemesterStatus] = useUpdateRegisteredSemesterMutation();
   ...
   const handleStatusUpdate =(data)=>{
    ...
    updatedSemesterStatus(updateData);
   };
    const menuProps ={
        items,
